...
function autoReflow() {
  ...
  const padBotPx = 16 * mmToPx; // Matches bottom padding in styles.css
...
function adjustSectionBreakSpacing() {
  ...
  const topMarginPx = 14 * mmToPx; // Matches the 14mm top padding of .paper in styles.css
